(function () {
    ...
    angular.module('sp-peoplepicker', []).directive('spPeoplePicker', function ($q, $timeout, $compile) {
        //Usage:
        //<sp-people-picker name="taskAssignee" id="taskAssignee" data-ng-model="$scope.taskAssignees" min-entries="1" max-entries="5" max-entries-to-show="4" allow-duplicates="false" show-login="false" show-title="true" min-characters="2" app-web-url="$scope.spAppWebUrl" />
        var directive = {
            link: link,
            restrict: 'EA',
            require: 'ngModel',
            ...
            controller: ['$scope', '$element', function ($scope, $element) {
                //$scope.appWebUrl = 'http://app-452bc12606d3ff.barazadevapps.org/operations/research-governance/internaldatarequest';
        ...
        function link(scope, element, attrs, ngModel) {
            ...
            $q.when().then(function() {
                ...
                scope.peoplePicker.MaxEntriesShown = scope.maxEntriesToShow;
